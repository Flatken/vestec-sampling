...
srun -N $1 -n $2 -c 56 --cpu-bind=no ./VestecCatalystEmulator /scratch/VESTEC-DATASETS/space_weather/run007/ .vtk 0.02 $PWD/scripts/criticalPoints_SpaceWeather.py > criticalPoints_spaceWeather_$1_$2_$3.csv
